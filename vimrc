...
"文件类型切换
nmap <leader>cpp :set ft=cpp<CR>
nmap <leader>py :set ft=py<CR>
nmap <leader>sh :set ft=sh<CR>
...
map <leader>gb :GitBranch<cr>

" conqueterm
map <leader>ct :ConqueTermSplit bash

"YouCompleteMe confifure
let g:ycm_global_ycm_extra_conf = '/home/cfylee/.vim/bundle/YouCompleteMe/cpp/ycm/.ycm_extra_conf.py'
